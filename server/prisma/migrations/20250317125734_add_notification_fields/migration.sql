...
INSERT INTO "new_Homework" ("createdAt", "deadline", "description", "id", "subjectId", "title", "updatedAt") SELECT "createdAt", "deadline", "description", "id", "subjectId", "title", "updatedAt" FROM "Homework";
DROP TABLE "Homework";
